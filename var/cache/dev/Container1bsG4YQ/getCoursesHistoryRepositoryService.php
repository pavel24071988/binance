...
// Returns the private 'App\Repository\CoursesHistoryRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CoursesHistoryRepository.php';

return $this->privates['App\Repository\CoursesHistoryRepository'] = new \App\Repository\CoursesHistoryRepository(($this->services['doctrine'] ?? $this->load(__DIR__.'/getDoctrineService.php')));
