...
$a->setNamespace('sf_orm_default_ed40fe8bfd58d37e6ce271b611f39ed06212287a8c6950c4ab693fbaf088b9eb');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_ed40fe8bfd58d37e6ce271b611f39ed06212287a8c6950c4ab693fbaf088b9eb');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_ed40fe8bfd58d37e6ce271b611f39ed06212287a8c6950c4ab693fbaf088b9eb');
...
$e->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\CoursesHistoryRepository' => function () {
    return ($this->privates['App\Repository\CoursesHistoryRepository'] ?? $this->load(__DIR__.'/getCoursesHistoryRepositoryService.php'));
}))));
